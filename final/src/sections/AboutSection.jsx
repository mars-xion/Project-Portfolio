...
const AboutSection = () => {
  return (
    <>
      ...
      >
        This website was done using Javascript, React, and Three.js. It is meant
        to show my skills in 3D websites and motion. This is extra text for now,
        just to fill up this parargrph until I see what I can do. Thank you for
